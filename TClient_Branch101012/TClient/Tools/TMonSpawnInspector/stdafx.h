...
#include <T3D.h>
#include <NetCode.h>
#include "TMonSpawnInspectorType.h"
#include <TClientID.h>

#pragma message("")
#pragma message("--TMonSpawnInspector에서 사용한 맵,오브젝트 로딩모듈은 엔진을 직접 호출한 것이 아닙니다.")
#pragma message("--따라서 엔진에서 맵과 오브젝트에 관련된 로딩방법이나 단위정책, 파일포맷 등이 변경되면")
#pragma message("--관련 TMonSpawInspector 클래스들을 직접 수정해야 합니다")
#pragma message("")
