...
void CTChatList::MoveComponent( CPoint pt )
{
	...
	SetOffset(rect.TopLeft() - CTClientUIBase::m_vBasis[GetBasis()]);
}
...
{
	// Arab Ver.
	CPoint pt = CTClientUIBase::m_vBasis[ GetBasis() ] + GetOffset();

	ScreenToComponent(&pt);
	CTChatList::MoveComponent(pt);
}
// ===============================================================================
...
// Arab Ver.
void CTChatList::SetOffset( CPoint vOffset)
{
