...
void CTSiegeUI::InitSiegeUI()
{
	...
	// Arab Ver.
	((TGauge*)m_pTGaugeBarAtk)->SetStyle(CTClientUIBase::GetGaugeDirection(TGS_GROW_RIGHT));
	((TGauge*)m_pTGaugeBarDef)->SetStyle(CTClientUIBase::GetGaugeDirection(TGS_GROW_RIGHT));
