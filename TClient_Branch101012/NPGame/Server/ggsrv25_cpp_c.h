...
GGAUTHS_API UINT32  __CDECL GGAuthCheckUserCSAuth(LPGGAUTH pGGAuth, bool bCheck);	// CheckUserCSAuth()
...
GGAUTHS_API INT32	 __CDECL GGAuthGetUserValue(LPGGAUTH pGGAuth, int type);
#endif
