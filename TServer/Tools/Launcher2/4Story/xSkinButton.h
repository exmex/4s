...
public:
	...
	BYTE SetSkin(LPCTSTR normal,LPCTSTR down, LPCTSTR over=NULL, LPCTSTR disabled=NULL, LPCTSTR focus=NULL,LPCTSTR mask=NULL,
				short drawmode=1,short border=0,short margin=0);
	void FlashButton();
...
protected:
	...
	CImage m_bNormal,m_bDown,m_bDisabled,m_bMask,m_bOver,m_bFocus; //skin bitmaps
