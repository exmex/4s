...
#define LAUNCHERWEB_NAME			_T("http://www.4story.com/news/launcher.asp")
...
//=====================================================================================
// 한국 버전만
#define SEARCHN_URL					_T("http://www.naver.com/")
#define SEARCHD_URL					_T("http://www.daum.net/")
#define SEARCHN_EXEC1				_T("http://search.naver.com/search.naver?where=nexearch&query=4%BD%BA%C5%E4%B8%AE&sm=top_hty&fbm=0")
#define SEARCHN_EXEC2				_T("http://search.naver.com/search.naver?where=nexearch&query=4%BD%BA%C5%E4%B8%AE+%BF%C2%B6%F3%C0%CE&sm=top_hty&fbm=1")
#define SEARCHN_EXEC3				_T("http://search.naver.com/search.naver?where=nexearch&query=%C6%F7%BD%BA%C5%E4%B8%AE&sm=top_hty&fbm=0")
#define SEARCHD_EXEC1				_T("http://search.daum.net/search?t__nil_searchbox=btn&nil_id=tot&w=tot&stype=tot&q=4%BD%BA%C5%E4%B8%AE")
#define SEARCHD_EXEC2				_T("http://search.daum.net/search?t__nil_searchbox=btn&nil_id=tot&w=tot&stype=tot&q=4%BD%BA%C5%E4%B8%AE%20%BF%C2%B6%F3%C0%CE")
//=====================================================================================
...
public:
	...
	void CheckRunningExe(CString strDestEXE);
