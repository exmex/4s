========================================================================
    정적 라이브러리 : TChart 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 TChart 라이브러리 프로젝트를 만들었습니다. 
이 파일에는 TChart 응용 프로그램을 구성하는 각각의 파일에
