================================================================================
              MFC 라이브러리 : TFontViewer 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 TFontViewer 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 TFontViewer 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
TFontViewer.h
    ...
    특정 헤더가 포함되며 CTFontViewerApp 응용 프로그램 클래스가 선언됩니다.

TFontViewer.cpp
    CTFontViewerApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\TFontViewer.ico
    ...
    이 아이콘은 주 리소스 파일인 TFontViewer.rc에 포함됩니다.
...
res\Toolbar.bmp
    ...
    리소스 편집기를 사용하여 도구 모음 비트맵을 편집하고 TFontViewer.rc의
    IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추에 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 단일 문서 종류 및 단일 뷰를 만듭니다.

TFontViewerDoc.h, TFontViewerDoc.cpp - 문서
    CTFontViewerDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CTFontViewerDoc::Serialize 사용).
TFontViewerView.h, TFontViewerView.cpp - 문서 뷰
    CTFontViewerView 클래스를 포함하는 파일입니다.
    CTFontViewerView 개체를 사용하여 CTFontViewerDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) TFontViewer.pch 및 미리 컴파일된
