...
void CTTranslatorDlg::BuildTQUEST_SQL( CFile *pLOG, LPTBDPARAM lParam)
{
	...
	for(int i=0; i<INT(m_vTQTITLE_SQL.size()); i++)
	{
	...
	for(int i=0; i<INT(m_vTQTERM_SQL.size()); i++)
	{
...
void CTTranslatorDlg::BuildTGAME_SQL( CFile *pLOG, LPTBDPARAM lParam)
{
	...
	for(int i=0; i<INT(m_vTSKILL_SQL.size()); i++)
	{
	...
	for(int i=0; i<INT(m_vTITEM_SQL.size()); i++)
	{
	...
	for(int i=0; i<INT(m_vTNPC_SQL.size()); i++)
	{
